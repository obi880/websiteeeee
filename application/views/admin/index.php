        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">SISTEM PENJADWALAN SIDANG</h1>
          ...
          <div class="col-xl-3 col-md-6 mb-4">
            ...
            <a href="<?= base_url('admin/data_guru'); ?>" style="text-decoration: none;">	
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Dosen</div>
      ...
      <div class="row">
      	  <div class="col-lg-10">
          	<p class="font-weight-bold"> Status Laporan Mahasiswa </p>
          	<hr class="sidebar-divider">
          </div>
      		<div class="col-xl-3 col-md-6 mb-4">
